  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {type === 'register' && (
        <>
          <div>
            <label className="block text-sm font-medium mb-1 text-[#007bff]">
              Nom complet
            </label>
            <input
              type="text"
              ...
              required
              className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-[#007bff] focus:border-[#007bff]"
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-[#ac1f1f] focus:border-[#007bff]"
      ...
      <button
        ...
        className={`w-full py-3 px-4 rounded-md text-white font-medium transition-colors ${
          loading ? 'bg-[#ac1f1f]/80' : 'bg-[#007bff] hover:bg-[#007bff]'
